...
namespace WebApiProjekti.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Tuotemäärät> Tuotemääräts { get; set; }
        public virtual DbSet<Tuotesummat> Tuotesummats { get; set; }
        public virtual DbSet<User> Users { get; set; }

        //connection stringin alkuperäinen huono sijainti josta se siirretty toisaalle ja configurointi hoidetaan siellä eli tätä ei edes tarvita
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Tuotemäärät>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Tuotemäärät");

                entity.Property(e => e.Tuotekoodi).ValueGeneratedOnAdd();
            });
            ...
            modelBuilder.Entity<Tuotesummat>(entity =>
            {
                ...
                entity.Property(e => e.Hinta).HasColumnType("money");
